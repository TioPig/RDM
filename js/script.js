document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    if (window.location.pathname === '../index.html' , '../login.html' , '../register.html') {
      const recetasUrl = "https://apirecetas.iacst.space/recetas"; // Endpoint para obtener todas las recetas
      const recetaRandomLink = document.getElementById("recetaRandomLink");
          ...
          fetch(recetasUrl)
              ...
              .then(data => {
                  if (data.ok && Array.isArray(data.data)) {
                      ...
                      <p style="text-align: justify !important;"><strong>Ingredientes:</strong> ${recetaAleatoria.ingrediente.replace(/\\n/g, ', ')}</p>
                      <p style="text-align: justify !important;"><strong>Preparación:</strong> ${recetaAleatoria.preparacion}</p>
                    `;
